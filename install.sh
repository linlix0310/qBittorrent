...
if [ "$ARCHITECTURE" == "x86_64" ]; then
    DOWNLOAD_URL="https://github.com/userdocs/qbittorrent-nox-static/releases/download/release-4.3.8_v1.2.14/x86_64-cmake-qbittorrent-nox"
    ...
    DOWNLOAD_URL="https://github.com/userdocs/qbittorrent-nox-static/releases/download/release-4.3.8_v1.2.14/aarch64-qbittorrent-nox"
else
...
sleep 2                      # 等待 2 秒
echo "y" | pkill -P $$ -f qbittorrent-nox || true  # 输入 "y" 并杀死子进程
